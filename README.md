...
1. 先列出项目需要的能力：认证、UI、移动端、表单与校验、国际化、后端 API、API 文档、API 网关、服务网格、工程化、数据库、数据库迁移、备份恢复、文件存储、文档处理、媒体处理、AI、内容管理、富文本编辑、工作流、实时通信、产品分析、图表可视化、地图地理、功能开关、配置密钥、支付、基础设施即代码、容器镜像、部署、CI/CD、测试、安全扫描、监控。
